...
/**
 * Servlet implementation class Test_postgresql2
 */
@WebServlet("/Test_postgresql2")
public class Test_postgresql2 extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public Test_postgresql2() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {
	      ...
	      // PostgreSQL JDBC 接続
//	      String url = "jdbc:postgresql://192.168.36.147/aisdb";
	      String url = "jdbc:postgresql://localhost/aisdb";
	        String user = "juser";
